...
const tasks = [
  {
    ...
    status: "in_progress",
    assignees: [
      { id: "a1", name: "张明", avatar: "张", status: "submitted", submittedAt: "2024-01-13 14:30" },
      { id: "a2", name: "李华", avatar: "李", status: "pending", submittedAt: null },
      { id: "a3", name: "王芳", avatar: "王", status: "approved", submittedAt: "2024-01-12 10:00" },
      { id: "a4", name: "赵强", avatar: "赵", status: "approved", submittedAt: "2024-01-11 16:45" },
      { id: "a5", name: "陈静", avatar: "陈", status: "rejected", submittedAt: "2024-01-13 09:00" },
    ],
  },
  {
    id: "2",
    ...
    status: "in_progress",
    assignees: [
      { id: "b1", name: "刘洋", avatar: "刘", status: "approved", submittedAt: "2024-01-12 11:30" },
      { id: "b2", name: "周婷", avatar: "周", status: "pending", submittedAt: null },
      { id: "b3", name: "吴磊", avatar: "吴", status: "pending", submittedAt: null },
    ],
  },
  {
    id: "3",
    ...
    status: "in_progress",
    assignees: [
      { id: "c1", name: "郑伟", avatar: "郑", status: "approved", submittedAt: "2024-01-10 09:00" },
      { id: "c2", name: "孙丽", avatar: "孙", status: "approved", submittedAt: "2024-01-10 10:30" },
      { id: "c3", name: "马超", avatar: "马", status: "submitted", submittedAt: "2024-01-14 15:00" },
      { id: "c4", name: "朱敏", avatar: "朱", status: "pending", submittedAt: null },
    ],
  },
];
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className="relative">
                                  ...
                                  <div className={`absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-card ${statusStyles[assignee.status as keyof typeof statusStyles].dot}`} />
                                </div>
                                <div>
